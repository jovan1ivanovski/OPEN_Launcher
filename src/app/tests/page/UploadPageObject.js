var uploadPage = function() {
    ...
    var uploadBtn = element(by.css("body > app > div > uploadpicture > div > div > div > div > input.btn.btn-success"));
    ...
    var uploadBtn = element(by.css("body > app > div > uploadpicture > div > div > div > div > input.btn.btn-success"));
    var choosePicture = element(by.css("body > app > div > uploadpicture > div > div > div > div > div > input"));
    var pathFiled = element(by.css("body > app > div > uploadpicture > div > div > div > div > input.form-control"));
